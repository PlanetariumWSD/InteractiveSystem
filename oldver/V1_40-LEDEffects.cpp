...
// ===========================================================
  ...
  byte LEDMaxBright[5] = {45, 255, 30, 100, 100};  // Master Max Brightness Values of indivisual LEDs to balance them out,  0-255 Anything over 125 is barely noticable to eye
