...
void setup()                    
{
   ...
   //cs_4_5.set_CS_AutocaL_Millis(0xFFFFFFFF);     // turn off autocalibrate on channel 2 - just as an example
   //cs_4_8.set_CS_AutocaL_Millis(0xFFFFFFFF);     // turn off autocalibrate on channel 3 - just as an example
                                                 // Default of 20 seconds or 200000 ms

    cs_4_2.set_CS_Timeout_Millis(50); // Set Time out for unresponsive pins in mS Defualt is 2000 ms
    cs_4_5.set_CS_Timeout_Millis(50);
    cs_4_8.set_CS_Timeout_Millis(50);
